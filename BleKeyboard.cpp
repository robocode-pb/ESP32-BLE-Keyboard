...
{
  BLEDevice::init(String(deviceName.c_str())); //BLEDevice::init(deviceName);
  ...
  hid->manufacturer()->setValue(String(deviceManufacturer.c_str())); //hid->manufacturer()->setValue(deviceManufacturer);
